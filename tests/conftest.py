...
# Limiares de PERCENTIL por classe de risco (ver _risco() em previsao_leve.py).
# O risco é derivado do campo `pct` (percentil diário), não da probabilidade bruta.
LIMIAR_BAIXO_MEDIO = 0.70   # pct < 0.70 → BAIXO
LIMIAR_MEDIO_ALTO  = 0.90   # pct >= 0.90 → ALTO
EPS = 0.01
